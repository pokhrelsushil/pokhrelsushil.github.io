      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-9 space-y-12">
            ...
            {/* Research Interests + Latest Updates */}
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Beyond my scholarly and professional pursuits, I maintain a deep commitment to reading as a 
                foundational practice of intellectual development. Through sustained engagement with literature 
                and research, I cultivate critical inquiry and interdisciplinary synthesis.
              </p>
            </div>
          </div>
        </div>
